...
const style = {
    ...
    button: `md:w-2/3 mx-auto p-2 bg-purple text-white  rounded-[5px] md:rounded-[15px] text-[24px] font-bold`,
        ...
        <div className={style.wrapper}>
            <div className={style.content}>
                <div className={style.mainContent}>
                  ...
                  <p className='font-open-sans mt-8 text-black text-center font-semibold text-[24px] leading-[32px]'>Shoppa allows you upload multiple products at once</p>
