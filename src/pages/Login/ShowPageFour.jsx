        ...
        <div className={style.wrapper}>
            <div className={style.content}>
                <div className={style.mainContent}>
                  ...
                  <p className='font-open-sans mt-8 w-2/3 mx-auto text-black text-center font-semibold text-[24px] leading-[32px]'>After filling in the details of the last item, click on “Upload Items”</p>
