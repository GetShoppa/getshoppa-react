...
const style = {
    ...
    button: `w-full p-2 bg-purple text-white  rounded-[5px] md:rounded-[15px] text-[24px] font-bold`,
        ...
        <div className={style.wrapper}>
            <div className={style.content}>
                <div className={style.mainContent}>
                  ...
                  <p className='font-open-sans mt-8 w-2/3 mx-auto text-black text-center font-semibold text-[24px] leading-[32px]'>Select one picture for each products you want to upload, then click on proceed</p>
