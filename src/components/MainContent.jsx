        ...
        <div className="font-poppins  mx-auto w-full pt-[5px] md:pt-[46px] bg-white md:bg-off-grey p-6">
            ...
            <div className="w-full mt-5">
                <div className="text-black md:bg-white bg-[#F1E6F2] my-3 flex flex-row p-4 border rounded-xl">
                    ...
                    <p className="text-[16px] leading-[22px] md:text-[32px] md:leading-[48px]">Crypto wallet, so you can collect crypto payments from your customers</p>
                </div>
                <div className="text-black md:bg-white bg-[#F1E6F2] my-3 flex flex-row p-4 border rounded-xl">
                    <img src={newMoonIcon} width={18} height={6} className="text-white mr-3" alt='icon'/>
                    <p className="text-[16px] leading-[22px] md:text-[32px] md:leading-[48px]">Escrow, to enable you securely collect payment from customers before delivery to prevent arguments</p>
                </div>
                <div className="text-black md:bg-white bg-[#F1E6F2] my-3 flex flex-row p-4 border rounded-xl">
                    <img src={newMoonIcon} width={18} height={6} className="text-white mr-3" alt='icon'/>
                    <p className="text-[16px] leading-[22px] md:text-[32px] md:leading-[48px]">Credit, we want to support you with funds to finance inventory & scale your business</p>
                </div>
                <div className="text-black md:bg-white bg-[#F1E6F2] my-3 flex flex-row p-4 border rounded-xl">
                    <img src={newMoonIcon} width={18} height={6} className="text-white mr-3" alt='icon'/>
                    <p className="text-[16px] leading-[22px] md:text-[32px] md:leading-[48px]">Virtual Account Number, get an account number that carries your business name</p>
                </div>
            </div>
            {/* <section id="form"> */}
